...
constexpr int switch_control_pin = 25;
...
volatile unsigned long last_emergency_time = 0;
const float current_sensor_Voffset = 1.65;
const float current_sensor_sensitivity = 0.132;
const float temp_sensor_zero_voltage = 0.500;
const float temp_sensor_sensitivity = 0.01;
static bool publishing_allowed = false;
void emergency_ISR();
void teensy_setup();
